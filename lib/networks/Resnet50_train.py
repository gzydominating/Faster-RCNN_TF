...
class Resnet50_train(Network):
    ...
    def setup(self):
        ...
        _feat_stride = [16, ]
        (self.feed('data')
             .conv2(7, 7, 64, 2, 2, relu=False, name='conv1')
        ...
        (self.feed('bn3a_branch1', 
             ...
             .conv2(1, 1, 128, 1, 1, biased=False, relu=False, name='res3b_branch2a')
             .batch_normalization(relu=True, name='bn3b_branch2a',is_training=False)
             .conv2(3, 3, 128, 1, 1, biased=False, relu=False, name='res3b_branch2b')
             .batch_normalization(relu=True, name='bn3b_branch2b',is_training=False)
             .conv2(1, 1, 512, 1, 1, biased=False, relu=False, name='res3b_branch2c')
        ...
        (self.feed('res3a_relu', 
             ...
             .conv2(1, 1, 128, 1, 1, biased=False, relu=False, name='res3c_branch2a')
             .batch_normalization(relu=True, name='bn3c_branch2a',is_training=False)
             .conv2(3, 3, 128, 1, 1, biased=False, relu=False, name='res3c_branch2b')
             .batch_normalization(relu=True, name='bn3c_branch2b',is_training=False)
             .conv2(1, 1, 512, 1, 1, biased=False, relu=False, name='res3c_branch2c')
        ...
        (self.feed('res3b_relu', 
             ...
             .conv2(1, 1, 128, 1, 1, biased=False, relu=False, name='res3d_branch2a')
             .batch_normalization(relu=True, name='bn3d_branch2a',is_training=False)
             .conv2(3, 3, 128, 1, 1, biased=False, relu=False, name='res3d_branch2b')
             .batch_normalization(relu=True, name='bn3d_branch2b',is_training=False)
             .conv2(1, 1, 512, 1, 1, biased=False, relu=False, name='res3d_branch2c')
        ...
        (self.feed('bn4a_branch1', 
             ...
             .conv2(1, 1, 256, 1, 1, biased=False, relu=False, name='res4b_branch2a')
             .batch_normalization(relu=True, name='bn4b_branch2a',is_training=False)
             .conv2(3, 3, 256, 1, 1, biased=False, relu=False, name='res4b_branch2b')
             .batch_normalization(relu=True, name='bn4b_branch2b',is_training=False)
             .conv2(1, 1, 1024, 1, 1, biased=False, relu=False, name='res4b_branch2c')
        ...
        (self.feed('res4a_relu', 
             ...
             .conv2(1, 1, 256, 1, 1, biased=False, relu=False, name='res4c_branch2a')
             .batch_normalization(relu=True, name='bn4c_branch2a',is_training=False)
             .conv2(3, 3, 256, 1, 1, biased=False, relu=False, name='res4c_branch2b')
             .batch_normalization(relu=True, name='bn4c_branch2b',is_training=False)
             .conv2(1, 1, 1024, 1, 1, biased=False, relu=False, name='res4c_branch2c')
        ...
        (self.feed('res4b_relu', 
             ...
             .conv2(1, 1, 256, 1, 1, biased=False, relu=False, name='res4d_branch2a')
             .batch_normalization(relu=True, name='bn4d_branch2a',is_training=False)
             .conv2(3, 3, 256, 1, 1, biased=False, relu=False, name='res4d_branch2b')
             .batch_normalization(relu=True, name='bn4d_branch2b',is_training=False)
             .conv2(1, 1, 1024, 1, 1, biased=False, relu=False, name='res4d_branch2c')
        ...
        (self.feed('res4c_relu', 
             ...
             .conv2(1, 1, 256, 1, 1, biased=False, relu=False, name='res4e_branch2a')
             .batch_normalization(relu=True, name='bn4e_branch2a',is_training=False)
             .conv2(3, 3, 256, 1, 1, biased=False, relu=False, name='res4e_branch2b')
             .batch_normalization(relu=True, name='bn4e_branch2b',is_training=False)
             .conv2(1, 1, 1024, 1, 1, biased=False, relu=False, name='res4e_branch2c')
        ...
        (self.feed('res4d_relu', 
             ...
             .conv2(1, 1, 256, 1, 1, biased=False, relu=False, name='res4f_branch2a')
             .batch_normalization(relu=True, name='bn4f_branch2a',is_training=False)
             .conv2(3, 3, 256, 1, 1, biased=False, relu=False, name='res4f_branch2b')
             .batch_normalization(relu=True, name='bn4f_branch2b',is_training=False)
             .conv2(1, 1, 1024, 1, 1, biased=False, relu=False, name='res4f_branch2c')
